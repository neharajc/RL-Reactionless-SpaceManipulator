...
def train_demo(episodes=30000, steps=750):
    ...
    BASE_VEL_LIMIT = 0.08        # success constraint
    TERMINAL_REWARD = 30.0       # reduced terminal reward
    ...
    with mujoco.viewer.launch_passive(model, data) as viewer:
        for ep in range(episodes):
            ...
            for step in range(steps):
                ...
                if curr_err < 0.75 and abs(base_vel) < BASE_VEL_LIMIT:
    ...
    # Save Q-table
    with open("q_table_newyearq2.pkl", "wb") as f:
