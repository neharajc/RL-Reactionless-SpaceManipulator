...
# -------------------------
# Training loop with reactionless and target-reaching reward
# -------------------------
def train_demo(episodes=20, steps=200):
    ...
    with mujoco.viewer.launch_passive(model, data) as viewer:
        for ep in range(episodes):
            ...
            # Random target angles for this episode
            target1 = random.uniform(0, 360)
            target2 = random.uniform(0, 360)
