...
# -------------------------
# Training loop with reactionless and fixed target-reaching reward
# -------------------------
def train_demo(episodes=20, steps=200, desired_target1=5.0, desired_target2=7.0):
    ...
    with mujoco.viewer.launch_passive(model, data) as viewer:
        for ep in range(episodes):
            ...
            # Fixed target angles (not random anymore)
            target1 = desired_target1
            target2 = desired_target2
            ...
            for step in range(steps):
                ...
                # Apply torques (reactionless: tau3 & tau4 compensate for tau1 & tau2)
                ...
                # -------------------------
                # Reward function: target-reaching + progress
                # -------------------------
                ...
                # Reward progress: positive if getting closer
                ...
                # Total reward
                reward = reward_progress + step_penalty

                # Terminal check
                tolerance = 0.5   # tighter tolerance for small range (0–10°)
                done = False
                if err < tolerance:
...
if __name__ == "__main__":
    # Example: target1 = 5°, target2 = 7°
    train_demo(episodes=50, steps=200, desired_target1=5.0, desired_target2=7.0)
