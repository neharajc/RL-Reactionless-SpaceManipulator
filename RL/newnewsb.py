...
class Hybrid5DOFEnv(gym.Env):
    ...
    def compute_reward(self, agent_action):
        ...
        # Bonus for base stability
        if abs(v[0]) < 0.05:
            reward += 0.5

        # Bonus for smooth actions
...
class ConvergenceCallback(BaseCallback):
    def __init__(self, eval_env, eval_freq=50000, reward_patience=15, min_eval_rewards=3, warmup_steps=40000):
        super().__init__()
